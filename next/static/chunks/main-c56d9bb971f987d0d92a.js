                            ...
                            return n.wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    ...
                                    case 61:
                                        ...
                                        if ($ = m.parseRelativeUrl(G), X = $.pathname, Q = _.getRouteRegex(V), K = b.getRouteMatcher(Q)(X), J = (Y = V === X) ? j(V, X, B) : {}, K && (!Y || J.result)) {
                                            t.next = 76;
                                            break
                                        }
                                        ...
                                        throw new Error((Y ? "The provided `href` (".concat(o, ") value is missing query values (").concat(Z.join(", "), ") to be interpolated properly. ") : "The provided `as` value (".concat(X, ") is incompatible with the `href` value (").concat(V, "). ")) + "Read more: https://nextjs.org/docs/messages/".concat(Y ? "href-interpolation-failed" : "incompatible-href-as"));
                                    case 74:
                                        t.next = 77;
                                        break;
                                    case 76:
                                        Y ? a = h.formatWithValidation(Object.assign({}, $, {
                                            pathname: J.result,
                                            query: A(B, J.params)
                                        })) : Object.assign(B, K);
                                    case 77:
